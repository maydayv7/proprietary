// CRT Effect (https://github.com/sigma-957/hyprland-shaders/blob/main/crt.frag)
...
vec4 applyPhosphorGlow(vec2 tc, vec4 color, sampler2D tex)
{
    ...
    sum = pixels[0] + pixels[1] + pixels[2] + pixels[3] + pixels[4] + pixels[5] + pixels[6] + pixels[7] + pixels[8];
    sum /= 9.0;
